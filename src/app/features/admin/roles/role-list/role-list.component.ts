        ...
        <div class="rounded-lg bg-white shadow-sm overflow-hidden">
          @if (loading) {
            <div class="flex justify-center items-center p-8">
              ...
              <span class="ml-4">Cargando roles...</span>
            </div>
            ...
            <div class="p-8 text-center">
              ...
              <h3 class="mt-2 text-sm font-medium text-gray-900">No se encontraron roles</h3>
              <p class="mt-1 text-sm text-gray-500">Comienza creando un nuevo rol.</p>
              <div class="mt-6">
                <a routerLink="/admin/roles/create" class="inline-flex items-center rounded-md bg-primary-600 px-4 py-2 text-sm font-medium text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
                  <svg class="-ml-1 mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                  </svg>
                  Nuevo Rol
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                          <div class="flex-shrink-0 h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center">
                            <span class="text-blue-800 font-medium">{{ getRoleInitials(role) }}</span>
                          </div>
                          <div class="ml-4">
                      ...
                      <td class="px-6 py-4">
                        <div class="flex flex-wrap gap-1 max-w-md">
                          @if (getPermissions(role).length) {
                            ...
                            <span class="text-xs text-gray-500">Sin permisos</span>
                          }
                        </div>
                      </td>
