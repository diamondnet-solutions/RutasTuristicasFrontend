  ...
  template: `
      <div class="space-y-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <h1 class="text-2xl font-bold text-gray-900">Permisos del Sistema</h1>
        </div>
        ...
        <div class="bg-white shadow-sm rounded-lg">
          ...
          @if (loading) {
            ...
            <div class="p-8 text-center">
              ...
              <p class="mt-1 text-sm text-gray-500">No hay permisos disponibles en el sistema.</p>
            </div>
          } @else {
            <div class="px-6 pb-6">
                ...
                @for (group of getPermissionGroups(); track group.groupName) {
                  <div class="border border-gray-200 rounded-md overflow-hidden">
                    <div class="bg-gray-50 px-4 py-3 border-b border-gray-200">
                      ...
                      <p class="mt-1 text-xs text-gray-500">{{ group.permissions.length }} permisos</p>
                    </div>
                    <div class="p-4">
                      <ul class="space-y-2">
